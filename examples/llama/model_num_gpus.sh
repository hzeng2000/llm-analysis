...
output_dir="/home/hzeng/prj/llm-analysis/results_3xsxm/results_"${model_name}""${total_num_gpus}"gpus_"${gpu_name}"_gb"
# output_dir="/home/hzeng/prj/llm-analysis/results_3xsxm/results_"${model_name}""${total_num_gpus}"gpus"
